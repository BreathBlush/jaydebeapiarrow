...
JayDeBeApiArrow converts JDBC result sets to Arrow record batches directly within the JVM, then streams them to Python — achieving up to **21x speedup** over the original jaydebeapi for large datasets.
